...
function fixImg(container: HTMLElement, alsoNonLazy = false) {
    ...
    when('consistent-part-images', (activated) => {
        ...
        const element = parseInt(elementMatch[1]);
