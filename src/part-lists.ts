...
async function processPartsInventory(inventoryContainer: HTMLElement) {
    ...
    if (await getSetting('checklist-range-selection')) {
        processCheckboxListForRangeSelection(inventoryContainer);
    }
...
const elementsNotAvailable = new Set([  // eslint-disable-next-line max-len
    394202, 623101, 4114379, 4114758, 4155062, 4157765, 4169489, 4183051, 4190219, 4215513, 4227598, 4519317, 4519318, 6138696, 6247781, 6296526, 6545657,
]);
